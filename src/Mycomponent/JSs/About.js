    ...
    <div>
      ...
      <div className="bg-about">
        ...
        {/* <div className="df row">
          <div className="card card-about nohover">
            <img src="" className="card-img-top" alt="..." />
            <div className="card-body df col">
              <span className="card-title">Late Kedar Nath Seth</span>
          ...
          <div className="card card-about nohover">
            <img src="" className="card-img-top" alt="..." />
            <div className="card-body df col">
              <span className="card-title">Late Rajendra Prasad Verma</span>
              <p className="card-text">Ex-CEO</p>
            </div>
          </div>
          <div className="card card-about nohover">
            <img src="" className="card-img-top" alt="..." />
            <div className="card-body df col">
              <span className="card-title">Late Jai Prakash Verma</span>
              <p className="card-text">Ex-CEO</p>
            </div>
          </div>
        </div>
        <div className="df row">
          <div className="card card-about nohover">
            <img src="" className="card-img-top" alt="..." />
            <div className="card-body df col">
              <span className="card-title">Akash Verma</span>
